...
directory: `godot-devkit`, `agentic-sdlc`, `nullbound`, `trail`.
...
- **nullbound:** `make doctor` FAILs on a stale uid index — 3 of 1199 tracked sidecars missing from
...
- **trail:** its `pm/README.md` convention was rewritten during the adoption — a no-build decision
