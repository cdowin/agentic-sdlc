...
**Evidence:** src/agentic_sdlc/cli.py:87
...
**Evidence:** src/agentic_sdlc/repo/pm/model.py:572
...
**Evidence:** src/agentic_sdlc/godot/checks/uid.py:151
...
**Evidence:** src/agentic_sdlc/godot/checks/tres.py:54
...
**Because:** v0.13.0 is the only written notice of the DECISIONS.md rename, and consumer_b is pinned at v0.10.0 and has not migrated
**Evidence:** CHANGELOG.md:1
