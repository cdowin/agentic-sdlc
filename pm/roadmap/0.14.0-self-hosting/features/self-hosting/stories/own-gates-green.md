...
milestone: "0.14.0"
name: check all is green inside agentic-sdlc
status: done
owner:
estimate:
depends_on: []
...
# check all is green inside agentic-sdlc

Running `agentic-sdlc check all` at this repo's root exits 0, with no gate
