...
**Evidence:** src/agentic_sdlc/repo/tasks.py:38
...
**Evidence:** src/agentic_sdlc/cli.py:98
...
**Evidence:** src/agentic_sdlc/repo/pm/model.py:864
...
**Evidence:** src/agentic_sdlc/repo/pm/cli.py:1360
...
**Evidence:** src/agentic_sdlc/repo/install.py:44
...
**Over:** the header model, where a file still carrying `GENERATED by agentic-sdlc` was overwritten without asking
...
**Evidence:** src/agentic_sdlc/repo/install.py:241
...
**Evidence:** src/agentic_sdlc/repo/installables/ci-verify.yml:1
...
**Evidence:** src/agentic_sdlc/repo/pm/model.py:42
...
**Evidence:** src/agentic_sdlc/repo/pm/cli.py:143
...
**Evidence:** src/agentic_sdlc/repo/pm/cli.py:225
...
**Because:** a key that does nothing is worse than one that errors — consumer_a ships `place_branch_on_building = true`, and on the pin bump it would have read as honoured. Raising it from `load()` would repeat the P9 defect this release fixes: one stale name taking `pm status` down with the gate
**Evidence:** src/agentic_sdlc/repo/pm/model.py:280
