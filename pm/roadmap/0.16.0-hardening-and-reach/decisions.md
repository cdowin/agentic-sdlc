...
(Script + addons exempt). Consequence accepted: ~33 consumer_a Script-plane non-canonical uids stay
...
consumer-adoption closed on wave 1 (consumer_b's pm wiring + the 9 uid fixes; consumer_a's surgery
