...
id: 0.20.0/init-verb
milestone: "0.20.0"
name: agentic-sdlc init — a blank Godot 4 project gets everything in one command
status: done
...
# agentic-sdlc init — a blank Godot 4 project gets everything in one command

What it makes true: `agentic-sdlc init` on an empty Godot 4 project writes, in order:
