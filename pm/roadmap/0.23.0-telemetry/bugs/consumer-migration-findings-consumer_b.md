---
id: 0.23.0/bugs/consumer-migration-findings-consumer_b
milestone: "0.23.0"
...
# consumer-migration-findings-consumer_b
...
verb. (Record as written by the consumer's agent; consumer_a's adoption hit the same class the same
...
`agentic-sdlc check` prints the general CLI help. `check --help` errors with the valid names
