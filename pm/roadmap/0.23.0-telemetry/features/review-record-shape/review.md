...
- `src/agentic_sdlc/repo/installables/reviewer.md:90` —
  `**Verdict:** PASS | PASS WITH WARNINGS | FAIL (has CRITICALs)`
- `src/agentic_sdlc/repo/installables/reviewer.md:110` —
  ``verdict:` is exactly one of SHIP, SHIP-WITH-FIXES, HOLD, RELEASE-SAFE,
  RELEASE-WITH-FIXES or NOT-RELEASE-SAFE`
- `src/agentic_sdlc/repo/installables/milestone-reviewer.md:83` —
  `**Verdict:** EXECUTION-READY / READY-WITH-FIXES / NOT-READY`
- `src/agentic_sdlc/repo/installables/milestone-reviewer.md:110` — the same
...
from agentic_sdlc.repo.pm import verdict as V
...
`src/agentic_sdlc/repo/pm/verdict.py:122-123` (`_LANDED`), and the paragraph at
