...
`src/agentic_sdlc/repo/installables/cc-ledger-subagent.sh` and
...
```text
$ cd /Users/cdowin/workspace/agentic-sdlc-0.23.0
...
documents.** `src/agentic_sdlc/repo/pm/cli.py:1558`.
