...
- `src/agentic_sdlc/repo/pm/model.py:122` — `HANDOFF_FILE_NAME = 'handoff.md'`
...
was filed. The consumer that does follow it is consumer_a, which has carried
...
The two consumer trees should be checked when this lands — consumer_a has one per active milestone,
consumer_b is unmeasured.
