---
id: 0.3.0/a-milestone-declares-its-version/03-no-code-path-parses-a-version
feature: 0.3.0/a-milestone-declares-its-version
milestone: "0.3.0"
name: no code path parses compares or increments a version string
status: done
owner:
depends_on: ["0.3.0/a-milestone-declares-its-version/02-r5-grades-the-current-release"]
---
