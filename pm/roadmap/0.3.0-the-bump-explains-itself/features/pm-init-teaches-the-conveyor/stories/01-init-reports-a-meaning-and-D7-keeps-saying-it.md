---
id: 0.3.0/pm-init-teaches-the-conveyor/01-init-reports-a-meaning-and-D7-keeps-saying-it
...
# init prints the ladder against the tree and D7 reports a declared unused state
...
3. `check pm` D7 reports a declared-but-never-used state as a WARN with the
...
| 5 | unit | `test_an_undeclared_word_in_the_tree_is_D4s_and_not_counted_here` | new — keeps D4 and D7 from arguing about the same byte |
...
D7 is OPT-IN, like every other flow-shaped rule. It is a WARN and could not
...
`pm init`, which prints unconditionally; D7 is how a project that wants it kept
...
done: ff58c03 — the ladder at adoption, D7 afterwards, and the finding pointed
at its own author.
