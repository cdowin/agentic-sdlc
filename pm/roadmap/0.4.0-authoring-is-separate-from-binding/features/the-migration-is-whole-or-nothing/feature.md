...
reviewed:
phase:
depends_on: ["0.4.0/identity-lives-in-frontmatter", "0.4.0/the-pools-are-the-tables", "0.4.0/binding-is-a-field", "0.4.0/the-order-is-one-mechanism", "0.4.0/every-row-names-its-grain", "0.4.0/one-rule-routes-a-row", "0.4.0/recording-is-on-or-the-gate-is-red"]
consumed_by: []
---
