---
id: 0.4.0/the-order-is-one-mechanism/01-order-sequences-every-container
feature: 0.4.0/the-order-is-one-mechanism
milestone: "0.4.0"
name: Every container sequences its children with order, and add is the verb
status: planning
owner:
depends_on: ["0.4.0/binding-is-a-field/02-rename-sweeps-every-inbound-ref"]
---
