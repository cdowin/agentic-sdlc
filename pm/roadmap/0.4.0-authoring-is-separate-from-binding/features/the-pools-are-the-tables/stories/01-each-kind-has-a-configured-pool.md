---
id: 0.4.0/the-pools-are-the-tables/01-each-kind-has-a-configured-pool
feature: 0.4.0/the-pools-are-the-tables
milestone: "0.4.0"
name: Each kind is read from its configured pool, relative to the repo root
status: planning
owner:
depends_on: ["0.4.0/identity-lives-in-frontmatter/02-the-resolvers-collapse-and-V2-retires"]
---
