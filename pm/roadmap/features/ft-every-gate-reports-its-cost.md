---
id: ft-every-gate-reports-its-cost
milestone: ms-0.2.0
...
size: m
phase: 3
depends_on: ["ft-the-kit-owns-the-gates-that-scan-its-own-artifacts"]
consumed_by: ["ft-the-release-is-a-conveyor"]
labels: ["telemetry", "ledger", "gates", "performance"]
kind: feature
order:
  - "st-the-ledger-holds-what-a-gate-cost"
  - "st-every-gate-path-leaves-a-row"
  - "st-the-report-answers-what-got-slower"
  - "st-a-dispatch-names-both-commands"
---
