---
id: ft-one-rule-routes-a-row
milestone: ms-0.4.0
name: One rule routes a row, and the in-progress lookup is deleted
status: done
reviewed: docs/reviews/2026-09-06-0.4.0-one-rule-routes-a-row.md
phase:
depends_on: []
consumed_by: []
kind: feature
order:
  - "st-routing-asks-the-grain-not-the-tree"
  - "st-a-grainless-row-lands-at-the-root"
---
