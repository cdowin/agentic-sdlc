---
id: ft-the-code-knows-entry-and-exit
milestone: ms-0.2.0
...
phase: 9
depends_on: ["ft-every-question-is-asked-of-a-category", "ft-the-ledger-rows-carry-categories", "ft-the-inner-levels-are-belts-too", "ft-the-belt-reports-and-finishes", "ft-the-project-declares-its-flow"]
consumed_by: []
kind: feature
order:
  - "st-each-kind-declares-its-own-states"
  - "st-ready-is-a-stamp-with-a-check"
  - "st-a-parent-behind-its-child-is-a-warning"
  - "st-a-belt-is-its-checks-then-one-write"
  - "st-open-bugs-are-named-and-the-three-are-fixed"
  - "st-the-review-findings-land"
  - "st-the-tree-closes-through-its-own-belts"
  - "st-every-surface-describes-the-tool-that-ships"
  - "st-the-whys-are-small"
---
