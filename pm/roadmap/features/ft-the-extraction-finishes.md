...
phase: 1
depends_on: []
consumed_by: ["ft-the-middle-tier-splits"]
labels: ["extraction", "defect", "docs", "installables"]
kind: feature
order:
  - "st-roster-equals-dispatchable"
  - "st-help-describes-what-ships"
  - "st-the-wheel-carries-only-what-has-a-reader"
  - "st-the-first-surfaces-describe-this-package"
---
