---
id: ft-the-kit-owns-the-gates-that-scan-its-own-artifacts
milestone: ms-0.2.0
...
consumed_by: ["ft-every-gate-reports-its-cost"]
labels: ["gates", "installables", "consumers", "subtraction"]
kind: feature
order:
  - "st-grain-prose-is-capped-by-the-kit-that-defines-the-grain"
  - "st-a-guard-nobody-wired-is-not-there"
---
