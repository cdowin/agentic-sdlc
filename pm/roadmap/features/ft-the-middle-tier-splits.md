...
size: m
phase: 2
depends_on: ["ft-the-extraction-finishes"]
consumed_by: ["ft-the-kit-owns-the-gates-that-scan-its-own-artifacts", "ft-the-story-belt-knows-what-verifies-this-edit"]
labels: ["extraction", "installables", "framework", "unblocks-godot-devkit"]
kind: feature
order:
  - "st-the-framework-composes-from-declared-tiers"
  - "st-a-named-tier-that-resolves-to-nothing-is-loud"
  - "st-the-godot-roster-leaves"
---
