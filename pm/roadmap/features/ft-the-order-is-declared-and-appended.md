---
id: ft-the-order-is-declared-and-appended
milestone: ms-0.3.0
...
phase:
depends_on: ["ft-a-milestone-declares-its-version"]
consumed_by: []
kind: feature
order:
  - "st-the-list-writer-preserves-every-other-byte"
  - "st-pm-order-and-pm-next"
  - "st-release-resolves-the-current-milestone"
---
