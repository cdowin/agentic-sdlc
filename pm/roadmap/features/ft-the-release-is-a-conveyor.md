---
id: ft-the-release-is-a-conveyor
milestone: ms-0.2.0
...
size: l
phase: 4
depends_on: ["ft-the-belts-refuse-to-advance", "ft-every-gate-reports-its-cost", "ft-the-story-belt-knows-what-verifies-this-edit"]
consumed_by: ["ft-adopt-is-a-conveyor"]
labels: ["release", "sdlc", "installable", "config", "subtraction"]
kind: feature
order:
  - "st-the-conveyor-refuses-to-advance"
  - "st-the-step-list-is-the-projects"
  - "st-the-gate-cannot-run-before-the-review-landed"
  - "st-every-deviation-is-a-ledger-row"
  - "st-the-protocol-is-rendered-from-the-list-that-runs"
---
