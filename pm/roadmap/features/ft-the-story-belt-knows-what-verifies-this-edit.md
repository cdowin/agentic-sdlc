---
id: ft-the-story-belt-knows-what-verifies-this-edit
milestone: ms-0.2.0
...
size: m
phase: 3
depends_on: ["ft-the-middle-tier-splits"]
consumed_by: ["ft-the-release-is-a-conveyor"]
labels: ["belts", "verify", "config", "economics"]
kind: feature
order:
  - "st-the-verify-declaration-is-read-or-refused"
  - "st-one-capture-runs-one-command"
  - "st-a-test-declares-what-it-covers"
  - "st-verify-answers-what-proves-this-edit"
  - "st-every-operation-has-one-rung"
---
