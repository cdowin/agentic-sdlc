...
kind: milestone
order:
  - "ft-the-extraction-finishes"
  - "ft-the-kit-owns-the-gates-that-scan-its-own-artifacts"
  - "ft-the-middle-tier-splits"
  - "ft-every-gate-reports-its-cost"
  - "ft-the-belts-refuse-to-advance"
  - "ft-the-story-belt-knows-what-verifies-this-edit"
  - "ft-adopt-is-a-conveyor"
  - "ft-the-release-is-a-conveyor"
  - "ft-the-belt-reports-and-finishes"
  - "ft-the-inner-levels-are-belts-too"
  - "ft-the-project-declares-its-flow"
  - "ft-the-suite-is-cheap-or-it-declares-itself"
  - "ft-every-question-is-asked-of-a-category"
  - "ft-the-proof-is-named-in-the-criterion"
  - "ft-the-ledger-rows-carry-categories"
  - "ft-the-code-knows-entry-and-exit"
---
