...
kind: milestone
order:
  - "ft-a-config-error-is-complete"
  - "ft-a-config-error-names-its-namespace"
  - "ft-a-milestone-declares-its-version"
  - "ft-adopt-grades-what-the-project-owns"
  - "ft-adopt-runs-where-the-bump-lives"
  - "ft-an-installers-report-is-complete"
  - "ft-documented-behaviour-is-the-behaviour"
  - "ft-pm-init-teaches-the-conveyor"
  - "ft-the-ledger-binds-to-the-current-release"
  - "ft-the-order-is-declared-and-appended"
  - "ft-the-plan-and-the-tree-agree"
---
