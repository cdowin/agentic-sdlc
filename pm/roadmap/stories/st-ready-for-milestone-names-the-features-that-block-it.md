---
id: st-ready-for-milestone-names-the-features-that-block-it
feature: ft-the-belts-refuse-to-advance
milestone: "ms-0.2.0"
name: ready-for milestone names every feature that is not done with a record
status: done
owner:
depends_on: ["st-ready-for-feature-names-the-stories-that-block-it"]
kind: story
---
