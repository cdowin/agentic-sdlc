---
id: st-verify-answers-what-proves-this-edit
feature: ft-the-story-belt-knows-what-verifies-this-edit
milestone: "ms-0.2.0"
name: verify --changed, --plan and --check answer from the tree
status: done
owner:
depends_on: ["st-one-capture-runs-one-command", "st-a-test-declares-what-it-covers"]
kind: story
---
