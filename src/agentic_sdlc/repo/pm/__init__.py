...
...plus `agentic_sdlc.repo.checks.pm`, the read side (the drift gate), which imports
...
laid out to the schema. It lives in agentic-sdlc because that is the pinned-tag
