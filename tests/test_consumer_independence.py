...
# committed corpus is a hiking game's data and legitimately spells `consumer_b_mile`
# and `c_on_trail`, which are domain vocabulary and not a project reference.
CONSUMER_NAMES = (r'\bconsumer_a\b', r'\bConsumerA\b', r'\bCONSUMER_A\b',
                  r'\btrail\b', r'\bTrail\b', r'\bTRAIL\b',
                  r'\bconsumer_c\b', r'\bConsumer_c\b')
