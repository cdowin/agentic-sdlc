...
# in this suite asks git anything. THIS module does — the whole module is `--from <rev>`, which IS a git range — so it opts in
# once, here, rather than at 22 call sites. An integration test declaring
