...
#
# STOCK ROSTER — the functions `agentic-sdlc install-runners` puts in every
...
while IFS= read -r segment; do
	...
	# arbitrary-name case is the accepted gap in the header). `agentic-sdlc`
